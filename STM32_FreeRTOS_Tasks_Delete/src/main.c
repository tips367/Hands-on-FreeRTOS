...
int main(void)
{
	...
	// 3. Create Task 1
	xTaskCreate(vTask1_handler, "TASK-1", 500, NULL, 1, &xTask1_handle);

	// 4. Create Task 2
	xTaskCreate(vTask2_handler, "TASK-2", 500, NULL, 2, &xTask2_handle);
...
void vTask2_handler(void *params)
{
	...
	while(1)
	{
		if(GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_0))
		{
			...
			printmsg("Task-2 is getting deleted\r\n");
			vTaskDelete(NULL);
		}
		else
		{
